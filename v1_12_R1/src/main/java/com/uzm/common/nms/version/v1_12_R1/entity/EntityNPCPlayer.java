...
import com.uzm.common.libraries.npclib.npc.skin.SkinPacketTracker;
...
import com.uzm.common.nms.version.v1_12_R1.network.EmptyNetHandler;
import com.uzm.common.nms.version.v1_12_R1.utils.player.PlayerControllerJump;
import com.uzm.common.nms.version.v1_12_R1.utils.player.PlayerControllerLook;
import com.uzm.common.nms.version.v1_12_R1.utils.player.PlayerControllerMove;
import com.uzm.common.nms.version.v1_12_R1.utils.player.PlayerNavigation;
...
public class EntityNPCPlayer extends EntityPlayer implements NPCHolder, SkinnableEntity {
    ...
    public void setTargetLook(net.minecraft.server.v1_12_R1.Entity target, float yawOffset, float renderOffset) {
    ...
    public void initialise() {
        ...
        this.playerConnection.networkManager.setPacketListener(this.playerConnection);
            ...
            for (Entity player : getEntity().getNearbyEntities(64.0, 64.0, 64.0)) {
                if (player instanceof Player) {
                    if (!(player instanceof PlayerNPC)) {
                        ...
                        for (int i = 0; i < EnumItemSlot.values().length; i++) {
                            packets[i] = new PacketPlayOutEntityEquipment(getId(), EnumItemSlot.values()[i], getEquipment(EnumItemSlot.values()[i]));
                        }
