...
public class PlayerPathfinder extends Pathfinder {
    ...
    public PathEntity a(IBlockAccess paramIBlockAccess, EntityNPCPlayer paramEntityInsentient,
    ...
    private PathEntity a(IBlockAccess paramIBlockAccess, EntityNPCPlayer paramEntityInsentient, double paramDouble1,
    ...
    public PathEntity a(IBlockAccess paramIBlockAccess, EntityNPCPlayer paramEntityInsentient, Entity paramEntity,
                        float paramFloat) {
