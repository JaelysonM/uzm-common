...
public class PlayerPathfinderNormal extends PlayerPathfinderAbstract {
    ...
    private PathType a(EntityNPCPlayer paramEntityInsentient, BlockPosition paramBlockPosition) {
        return a(paramEntityInsentient, paramBlockPosition.getX(), paramBlockPosition.getY(),
                paramBlockPosition.getZ());
    }

    private PathType a(EntityNPCPlayer paramEntityInsentient, int paramInt1, int paramInt2, int paramInt3) {
        return a(this.a, paramInt1, paramInt2, paramInt3, paramEntityInsentient, this.d, this.e, this.f, d(), c());
    }

    @Override
    public void a(IBlockAccess paramIBlockAccess, EntityNPCPlayer paramEntityInsentient) {
    ...
    public PathType a(IBlockAccess paramIBlockAccess, int paramInt1, int paramInt2, int paramInt3,
                      EntityNPCPlayer paramEntityInsentient, int paramInt4, int paramInt5, int paramInt6, boolean paramBoolean1,
        ...
        PathType localObject = PathType.BLOCKED;
        for (PathType localPathType2 : localEnumSet) {
            if (paramEntityInsentient.a(localPathType2) < 0.0F) {
                return localPathType2;
            }
            if (paramEntityInsentient.a(localPathType2) >= paramEntityInsentient.a(localObject)) {
                localObject = localPathType2;
            }
        }
        if ((localPathType1 == PathType.OPEN) && (paramEntityInsentient.a(localObject) == 0.0F)) {
    ...
    public PathPoint b() {
        ...
        localObject1 = new BlockPosition(this.b);
        PathType localObject2 = a(this.b, localObject1.getX(), i, localObject1.getZ());
        if (this.b.a(localObject2) < 0.0F) {
    ...
    protected PathType b(IBlockAccess paramIBlockAccess, int paramInt1, int paramInt2, int paramInt3) {
        ...
        if (((localBlock instanceof BlockDoor)) && (localMaterial == Material.WOOD)
                && (!localIBlockData.get(BlockDoor.OPEN))) {
        ...
        if (((localBlock instanceof BlockDoor)) && (localIBlockData.get(BlockDoor.OPEN))) {
        ...
        if (((localBlock instanceof BlockFence)) || ((localBlock instanceof BlockCobbleWall))
                ...
                && (!localIBlockData.get(BlockFenceGate.OPEN)))) {
            return PathType.FENCE;
        }
