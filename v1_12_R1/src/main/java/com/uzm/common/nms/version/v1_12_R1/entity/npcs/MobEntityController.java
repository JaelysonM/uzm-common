...
import com.uzm.common.libraries.npclib.npc.AbstractEntityController;
...
public abstract class MobEntityController extends AbstractEntityController {
    ...
    protected Entity createEntity(Location at, NPC npc) {
        net.minecraft.server.v1_12_R1.Entity entity = createEntityFromClass(((CraftWorld) at.getWorld()).getHandle(), npc);
