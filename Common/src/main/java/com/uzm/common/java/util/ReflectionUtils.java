...
public final class ReflectionUtils {
    ...
    /**
     * Returns a classes from JavaPlugin
     *
     * @param packageName Package name
     * @param plugin      Plugin
     * @return {@link List<>} with package classes./
     */
    ...
    public static List<Class<?>> getClasses(String packageName, JavaPlugin plugin) {
        ...
        try {
            ...
            System.err.println("An error occurred while the plugin tried to load classes");
        }
        return classes;
    }
     ...
     * @see DataType#getPrimitive(Object[])
     */
    public static Object invokeMethod(Object obj, String methodName) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException {
     ...
     * @see DataType#getPrimitive(Object[])
     */
    public static Object invokeMethod(Class<?> clazz, Object obj, String methodName) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException {
        return getMethod(clazz, methodName).invoke(obj);
    }
     ...
     * @param obj        Target object
     * @param methodName Name of the desired method
     * @param args       Arguments type of method
     * @param initargs   Arguments of method.
     * @return The result of invoking the desired method on the target object
     * @throws IllegalAccessException    If the desired method cannot be accessed due to certain circumstances
     * @throws IllegalArgumentException  If the types of the arguments do not match the parameter types of the method (this should not occur since it searches for a method with the types of the arguments)
     * @throws InvocationTargetException If the desired method cannot be invoked on the target object
    ...
    public static Object invokeMethod(Class<?> clazz, Object obj, String methodName, Class<?>[] args, Object... initargs)
            throws Exception {
        return Objects.requireNonNull(getMethod(clazz, methodName, args)).invoke(obj, initargs);
    }
     ...
     */
    public static Object invokeMethod(Object instance, String className, PackageType packageType, String
            methodName, Object... arguments) throws
     ...
     */
    public static Field getField(Class<?> clazz, boolean declared, String fieldName) throws
     ...
     */
    public static Field getField(String className, PackageType packageType, boolean declared, String fieldName) throws
    ...
    public static Object getValue(Object instance, String className, PackageType packageType,
                                  boolean declared, String fieldName) throws
            IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException, ClassNotFoundException {
     ...
     * @see #getField(Class, boolean, String)
     */
    public static void setValue(Object instance, Class<?> clazz, boolean declared, String fieldName, Object value) throws
            IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
