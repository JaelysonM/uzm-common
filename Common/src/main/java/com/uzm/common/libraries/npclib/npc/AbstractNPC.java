...
import com.uzm.common.libraries.npclib.api.event.NPCDespawnEvent;
import com.uzm.common.libraries.npclib.api.event.NPCNeedsRespawnEvent;
import com.uzm.common.libraries.npclib.api.event.NPCSpawnEvent;
import com.uzm.common.libraries.npclib.api.metadata.MetadataStore;
import com.uzm.common.libraries.npclib.api.metadata.SimpleMetadataStore;
...
import com.uzm.common.libraries.npclib.trait.CurrentLocation;
import com.uzm.common.libraries.npclib.trait.LookClose;
import com.uzm.common.libraries.npclib.trait.NPCTrait;
...
public class AbstractNPC implements NPC {
    ...
    public boolean spawn(Location location) {
        ...
        boolean couldSpawn = MathUtils.isLoaded(location) && NMS.addEntityToWorld(getEntity(), SpawnReason.CUSTOM);
    ...
    @Override
    public void tick() {
        if (getTrait(LookClose.class) != null) {
            getTrait(LookClose.class).run();
        }
    }
