...
public class ItemBuilder {
    ...
    public ItemBuilder(String item) {
        ...
        try {
            ...
            for (int i = 2; i < split.length; i++) {
                ...
                if (opt.startsWith("skinvalue=") && skull != null) {
                    try {
                        ...
                        Common.getInstance().getLogger().log(Level.WARNING, "Unexpected error ocurred profile on skull: ", ex);
                    }
                }
            ...
            Common.getInstance().getLogger().log(Level.WARNING, "Cant deserializeItem() from \"" + item + "\"", ex);
            this.item = new ItemStack(Material.BARRIER, 1);

        }
    }

    public ItemBuilder dyeBannerColor(byte data) {
        DyeColor c = DyeColor.getByDyeData(data);
        BannerMeta banner = (BannerMeta) this.item.getItemMeta();
        banner.setBaseColor(c);
        this.item.setItemMeta(banner);
        return this;
    }
    ...
    public ItemBuilder loreClean(String... strings) {
        if ((this.item == null) || (this.meta == null)) {
            return this;
        }
        String[] arrayOfString;
    ...
    public ItemStack build(boolean glow) {
        ...
        if (!this.lore.isEmpty()) {
            this.lore.replaceAll(s -> ChatColor.translateAlternateColorCodes('&', s));
