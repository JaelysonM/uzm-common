package com.uzm.common.plugin.logger;
...
public class CustomLogger extends PluginLogger {
    ...
    public CustomLogger(Plugin plugin) {
        super(plugin);
        this.plugin = plugin;
        this.prefix = "§b[" + plugin.getName() + "] ";
        this.sender = Bukkit.getConsoleSender();
    }

    public CustomLogger(CustomLogger parent, String prefix) {
        super(parent.plugin);
    ...
    public CustomLogger getModule(String module) {
        return new CustomLogger(this, module + ": ");
    }
