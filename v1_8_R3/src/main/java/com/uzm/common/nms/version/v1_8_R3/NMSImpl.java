package com.uzm.common.nms.version.v1_8_R3;
...
import com.uzm.common.nms.version.v1_8_R3.entity.npcs.*;
...
public class NMSImpl implements INMS {
    ...
    public Hologram getHologram(org.bukkit.entity.Entity entity) {
        ...
        HologramLine e = ((com.uzm.common.nms.version.v1_8_R3.entity.EntityArmorStand) en).getLine();
    ...
    public IArmorStand createArmorStand(Location location, String name, HologramLine line) {
        ...
        IArmorStand armor =
                line == null ? new EntityStand(location) : new com.uzm.common.nms.version.v1_8_R3.entity.EntityArmorStand(((CraftWorld) location.getWorld()).getHandle(), line);
